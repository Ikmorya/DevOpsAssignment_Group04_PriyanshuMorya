...
export default function RetrievePage() {
  ...
  const handleRetrieve = async () => {
    ...
    try {
      ...
      setError((e as Error).message || 'Code not found or expired.');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="container" style={{ maxWidth: 640, paddingTop: 40, paddingBottom: 80 }}>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <Link to="/upload" id="go-upload-btn" className="btn btn-primary btn-full">
            ↑ Upload Files
          </Link>
        </div>
      </div>
      ...
      <div className="two-col-right">
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-secondary">
            Don&apos;t have a code?{' '}
            <Link to="/upload" style={{ color: 'var(--accent-1)', fontWeight: 600 }}>Upload files →</Link>
          </p>
        </div>
      </div>
    </div>
